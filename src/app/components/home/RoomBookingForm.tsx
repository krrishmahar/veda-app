...
const RoomBookingForm = () => {
  // const [arrivalDate, setArrivalDate] = useState<Dispatch<SetStateAction<dayjs.Dayjs>> | null>(dayjs());
                ...
                {showArrivalPicker && (
                  ...
                  >
                    <StaticDatePicker
                      ...
                      value={arrivalDate}
                      onChange={(newDate) => {
                        if (newDate) setArrivalDate(newDate); // Only update if the date is valid
                      }}
                ...
                {showDeparturePicker && (
                  ...
                  >
                    <StaticDatePicker
                      ...
                      value={departureDate}
                      onChange={(newDate) => {
                        if (newDate) setDepartureDate(newDate); // Only update if the date is valid
                      }}
