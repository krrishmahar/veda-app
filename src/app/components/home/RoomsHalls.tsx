...
import HoverRating from '@/app/components/home/HoverRating';
...
const RoomsHalls:FC<EndpointProp> = ({ endpoint }) => {
    const [currentSlide, setCurrentSlide] = useState(0);
    const [items, setItems] = useState<Item[]>([]);  // Initialize as an empty array
    const totalSlides = 3;
